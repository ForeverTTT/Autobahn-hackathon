"""
Centralized configuration constants for RAG.

This module defines default values for configuration constants used across
different parts of the RAG system. Centralizing these values ensures
